...
func (tc *TeacherCreate) SetFirstName(s string) *TeacherCreate {
	tc.mutation.SetFirstName(s)
	return tc
}

// SetNillableFirstName sets the "first_name" field if the given value is not nil.
func (tc *TeacherCreate) SetNillableFirstName(s *string) *TeacherCreate {
	if s != nil {
		tc.SetFirstName(*s)
	}
	return tc
...
func (tc *TeacherCreate) SetNillableLastName(s *string) *TeacherCreate {
	if s != nil {
		tc.SetLastName(*s)
	}
	return tc
...
func (tc *TeacherCreate) AddCourseIDs(ids ...uuid.UUID) *TeacherCreate {
